...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.0f, 0.0f, 0.0f);  //COLOR QUE TENDRA EL OBJETO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMesh(); //dibuja cubo y pirámide triangular, pirámide base cuadrangular
		
		//CARA ROSA
		//Punta 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 4.6f, -0.8f));
		model = glm::scale(model, glm::vec3(1.2f, 1.2f, 1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.5f);  //COLOR QUE TENDRA EL OBJETO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMesh(); //dibuja cubo y pirámide triangular, pirámide base cuadrangular
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.5f, 1.0f, 1.0f);  //COLOR QUE TENDRA EL OBJETO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMesh(); //dibuja cubo y pirámide triangular, pirámide base cuadrangular
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.5f, 3.3f, -1.5f)); //z -1.20
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.5f, 1.9f, -1.9f)); //z -1.20
		model = glm::rotate(model, glm::radians(169.0f), glm::vec3(1.0f, 0.0f, 0.0f));//z -0.00
		model = glm::rotate(model, glm::radians(50.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(20.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.3f, 1.2f, 1.2f));
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.5f, 1.0f, 0.2f);  //COLOR QUE TENDRA EL OBJETO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMesh(); //dibuja cubo y pirámide triangular, pirámide base cuadrangular
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.5f, 1.0f, 0.0f);  //COLOR QUE TENDRA EL OBJETO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMesh(); //dibuja cubo y pirámide triangular, pirámide base cuadrangular
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.3f, 0.3f);  //COLOR QUE TENDRA EL OBJETO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMesh(); //dibuja cubo y pirámide triangular, pirámide base cuadrangular
