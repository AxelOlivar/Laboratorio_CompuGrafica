...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));//rotación alrededor de la articulación que une con la cabina
		modelaux = model;
		...
		//modelaux = model;
		//model = glm::scale(model, glm::vec3(6.0f, 2.1f, 2.8f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		//glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		//model = modelaux;
		////segundo brazo
		//model = glm::translate(model, glm::vec3(-1.0f, -2.3f, 0.0f));
		//model = glm::rotate(model, glm::radians(-25.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		//modelaux = model;
		...
		//model = glm::rotate(model, glm::radians(mainWindow.getarotallanta1()), glm::vec3(0.0f, 0.0f, 1.0f));
		//modelaux = model;
		...
		//model = glm::rotate(model, glm::radians(mainWindow.getarotallanta2()), glm::vec3(0.0f, 0.0f, 1.0f));
		//modelaux = model;
		//model = glm::rotate(model, glm::radians(270.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		//model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//model = glm::rotate(model, glm::radians(mainWindow.getarotallanta3()), glm::vec3(0.0f, 0.0f, 1.0f));
		//modelaux = model;
		//model = glm::rotate(model, glm::radians(270.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		//model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//////llanta 4
		//model = modelaux5;
		//model = glm::translate(model, glm::vec3(4.5f, 0.0f, 3.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarotallanta4()), glm::vec3(0.0f, 0.0f, 1.0f));
		//modelaux = model;
		//model = glm::rotate(model, glm::radians(270.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		//model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
